...
# ── PUT /courses/<id>  (conductor who created it / admin) ─────────────────
...
# ── DELETE /courses/<id>  (conductor who created it / admin) ──────────────
...
# ── POST /courses/<id>/purchase  (any authenticated user) ─────────────────
# Note: actual payment is handled by /payments/create-order
